...
<%
	...
	ArrayList<Item> list = 	(ArrayList<Item>)Manager.listByQuery("from "+Item.class.getName() + " i where i.level > '0' and i.level >= '"+ (npc.getLevel()-1) + "' and i.level <= '"+ (npc.getLevel()+1)+ "'");
